...
class SimpleUnitOperatorTest {
    ...
    fun derivedUnitConversion() {
        val m: AbstractUnit = SimpleFundamentalUnit()
        val km: AbstractUnit = m * 1000.0
        val km2: AbstractUnit = SimpleDerivedUnit.of(km % 2)
        val cm: AbstractUnit = m / 100.0
        val cm2: AbstractUnit = SimpleDerivedUnit.of(cm % 2)
    ...
    fun combinedDimensionDerivedUnitConversion() {
        ...
        val gPerM2: AbstractUnit = SimpleDerivedUnit.of(g, m % -2)
        val km: AbstractUnit = m * 1000.0
        val tonPerKm2: AbstractUnit = SimpleDerivedUnit.of(ton, km % -2)
        val cm: AbstractUnit = m / 100.0
        val tonPerCm2: AbstractUnit = SimpleDerivedUnit.of(ton, cm % -2)
    ...
    fun temperatures() {
        ...
        val m: AbstractUnit = SimpleFundamentalUnit()
        val cPerM: AbstractUnit = SimpleDerivedUnit.of(c, m % -1)
        val kPerM: AbstractUnit = SimpleDerivedUnit.of(k, m % -1)
    ...
    fun speed() {
        ...
        val ms: AbstractUnit = SimpleDerivedUnit.of(m, s % -1)
        val kmh: AbstractUnit = SimpleDerivedUnit.of(km, h % -1)
